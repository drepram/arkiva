    ...
    <main className="about-page">
      ...
      <div className="about-sections">
        <details className="about-section" open>
          <summary><span>Who We Are</span><span className="about-toggle" aria-hidden="true">+</span></summary>
        ...
        <details className="about-section">
          <summary><span>Why This Archive Exists</span><span className="about-toggle" aria-hidden="true">+</span></summary>
          <div className="about-section-body">
        ...
        <details className="about-section">
          <summary><span>Disclaimer</span><span className="about-toggle" aria-hidden="true">+</span></summary>
          <div className="about-section-body">
